...
<!-- TOC -->
## Usage
 - For a very basic uncustomized logger you can call Logger::basic(Brain), passing in the brain that should be defined earlier in your autogenerated main.cpp
 ```c++
 #include "logger.h"

 auto LOGGER = Logger::basic(Brain);
 ```
